...
Windows [fonts](https://en.wikipedia.org/wiki/Computer_font) can be used to visualize [point](point) layers with symbols in a MapView. 
...
![](../assets/img/GUI/dms_ttf.png)  

Use the SymbolIndex [parameter](parameter) to configure a character from this set, see the example:
