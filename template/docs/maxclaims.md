...
nav_exclude: true
---
*[allocation-functions](allocation-functions), argument 9: MaxClaims*

## definition

MaxClaims is the ninth [argument](argument) of the discrete_alloc function.
...
The values unit of the each MaxClaim attribute with [value-type](value-type): uint32
